...
import { SERVICES, FAQS, SERVICE_FAQS, SITE_URL } from "@/lib/constants"
import {
  Accordion,
  AccordionItem,
  AccordionTrigger,
...
export default async function ServicePage({ params }: Props) {
  ...
  const serviceFaqs = SERVICE_FAQS[service.slug] ?? []
  const allFaqs = [...serviceFaqs, ...FAQS]
...
function getServiceBenefits(slug: string): string[] {
  const benefits: Record<string, string[]> = {
    mowing: [
      ...
      "Striped finishes for a premium look",
    ],
    weeding: [
    ...
    edging: [
      "Crisp, defined borders along all paths and driveways",
      "Garden bed and fence line edging",
      "Nature strip edging for street appeal",
      "Professional line trimmers for a precise finish",
      "Bundle with mowing for a complete look",
    ],
    "pressure-cleaning": [
    ...
    "mulching-landscaping": [
      "Quality bark, eucalyptus or decorative mulch",
      "Garden bed creation and reshaping",
      "Soil preparation and improvement",
      "Weed suppression and moisture retention",
      "Small-scale landscaping and plant installation",
    ],
    "rubbish-removal": [
      "Green waste, branches and clippings cleared",
      "Old pots, pavers and garden debris removed",
      "Responsible disposal at licensed facilities",
      "Pre-sale and rental property clean-outs",
      "Bundle with garden tidy for a complete transformation",
    ],
  }
